var OneTrustStub = ((t) => {
        ...
        for (; (u = l && e[(l = 0)] ? 0 : u); )
          try {
            ...
            switch (((s = 0), (e = r ? [2 & e[0], r.value] : e)[0])) {
              ...
              default:
                if (
                  !(r = 0 < (r = u.trys).length && r[r.length - 1]) &&
                  (6 === e[0] || 2 === e[0])
                ) {
                  u = 0;
                  continue;
  ...
  var i,
    ...
    c = new (function () {
      ((this.optanonCookieName = "OptanonConsent"),
        ...
        (this.userLocation = { country: "", state: "", stateName: "" }));
    })(),
    s =
      (((y = i = i || {})[(y.Days = 1)] = "Days"),
      (y[(y.Weeks = 7)] = "Weeks"),
      (y[(y.Months = 30)] = "Months"),
      (y[(y.Years = 365)] = "Years"),
      ((y = n = n || {}).GDPR = "GDPR"),
      (y.CCPA = "CCPA"),
      (y.IAB2 = "IAB2"),
      ...
      (y.GENERIC = "GENERIC"),
      (y.LGPD = "LGPD"),
      (y.GENERIC_PROMPT = "GENERIC_PROMPT"),
      (y.CPRA = "CPRA"),
      (y.CDPA = "CDPA"),
      (y.DELAWARE = "DELAWARE"),
      (y.IOWA = "IOWA"),
      (y.NEBRASKA = "NEBRASKA"),
      (y.USNATIONAL = "USNATIONAL"),
      (y.CUSTOM = "CUSTOM"),
      (y.FLORIDA = "FLORIDA"),
      (y.COLORADO = "COLORADO"),
      (y.CONNECTICUT = "CTDPA"),
      ...
      (y.TEXAS = "TEXAS"),
      (y.OREGON = "OREGON"),
      (y.TENNESSEE = "TENNESSEE"),
      (y.NEWJERSEY = "NEWJERSEY"),
      (y.NEWHAMPSHIRE = "NEWHAMPSHIRE"),
      (y.UCPA = "UCPA"),
      (y.VIRGINIA = "VIRGINIA"),
      n.CPRA,
      n.CDPA,
      ...
      n.NEWHAMPSHIRE,
      n.UCPA,
      ((y = S = S || {}).Name = "OTGPPConsent"),
      (y[(y.ChunkSize = 4e3)] = "ChunkSize"),
      (y.ChunkCountParam = "GPPCookiesCount"),
      (y.gppSid = "gppSid"),
      ((n = a = a || {}).CPRA = "usca"),
      (n.CCPA = "usca"),
      (n.CDPA = "usva"),
      ...
      (y[(y.CCPA = 8)] = "CCPA"),
      (y[(y.CDPA = 9)] = "CDPA"),
      (y[(y.OREGON = 15)] = "OREGON"),
      (y[(y.USNATIONAL = 7)] = "USNATIONAL"),
      (y[(y.COLORADO = 10)] = "COLORADO"),
      (y[(y.FLORIDA = 13)] = "FLORIDA"),
      (y[(y.MONTANA = 14)] = "MONTANA"),
      (y[(y.TEXAS = 16)] = "TEXAS"),
      (y[(y.DELAWARE = 17)] = "DELAWARE"),
      (y[(y.IOWA = 18)] = "IOWA"),
      (y[(y.NEBRASKA = 19)] = "NEBRASKA"),
      (y[(y.NEWHAMPSHIRE = 20)] = "NEWHAMPSHIRE"),
      (y[(y.NEWJERSEY = 21)] = "NEWJERSEY"),
      (y[(y.TENNESSEE = 22)] = "TENNESSEE"),
      (y[(y.UCPA = 11)] = "UCPA"),
      (y[(y.VIRGINIA = 9)] = "VIRGINIA"),
      (y[(y.CTDPA = 12)] = "CTDPA"),
      (y[(y.IAB2V2 = 2)] = "IAB2V2"),
      "geo"),
    l = "otpreview",
    ...
    d =
      ...
      i.Months,
      i.Years,
      (h.prototype.camelize = function (t) {
        return (t = t.replace("--", ""))
          .split("-")
          .map(function (t, e) {
    ...
    this.implementThePolyfill = function () {
      ...
      return (
        (Element.prototype.setAttribute = function (t, e) {
          ...
          if (
            ("style" !== i && s.apply(this, [t, e]),
            "style" !== i || e || this.removeAttribute("style"),
            "style" === i && e)
          ) {
  ...
  var g = new (function () {
    ...
    f =
      ((A.initCSPTrustedType = function (t) {
        var n = new URL(t, location.origin);
        window.DOMPurify &&
          window.trustedTypes &&
          window.trustedTypes.createPolicy &&
          (window.OtTrustedType.TrustedTypePolicy =
            window.trustedTypes.createPolicy("ot-trusted-type-policy", {
              ...
              createScriptURL: function (t) {
                var e,
                  i = [document.location.hostname, n.hostname];
                try {
                  e = new URL(t, location.origin);
                } catch (t) {
                  return "about:blank#error";
                }
                return e.hostname && !i.includes(e.hostname)
                  ? "about:blank#blocked"
                  : e.href;
              },
            }));
      ...
      (A.isCspTrustedType = function () {
        var t;
        return (
          (null == (t = window.OtTrustedType)
            ? void 0
            : t.isCspTrustedTypeEnabled) &&
          (null == (t = window.OtTrustedType) ? void 0 : t.TrustedTypePolicy)
        );
      }),
      (A.createScriptURL = function (t) {
        return A.isCspTrustedType()
          ? window.OtTrustedType.TrustedTypePolicy.createScriptURL(t)
          : t;
      }),
      (A.checkAndAssignCspTrustedTypeEnabled = function (t) {
        t = null == (t = t.TenantFeatures) ? void 0 : t.CookieV2CSPTrustedType;
        return ((window.OtTrustedType = { isCspTrustedTypeEnabled: t }), t);
      }),
      A);
  function A() {}
  ((b.prototype.initConsentSDK = function () {
    ...
    (b.prototype.captureNonce = function () {
      this.nonce =
        c.stubScriptElement.nonce ||
        c.stubScriptElement.getAttribute("nonce") ||
        null;
    }),
    (b.prototype.captureShopify = function () {
      this.isShopify = c.stubScriptElement.hasAttribute(
        "data-shopify-consent-mapping",
      );
    }),
    (b.prototype.fetchBannerSDKDependency = function () {
      (this.setDomainDataFileURL(),
        (this.crossOrigin =
          c.stubScriptElement.getAttribute("crossorigin") || null),
        (this.previewMode =
          "true" === c.stubScriptElement.getAttribute("data-preview-mode")),
    ...
    (b.prototype.getLocation = function (t) {
      if (
        ...
        (this.subDomainEnabled = t.SubDomainEnabled || !1),
        (this.domainHashValue = t.DomainHashValue || ""),
        (this.scriptType = t.ScriptType || ""),
        ...
        ((t.TenantFeatures && t.TenantFeatures.CookieV2CSP) ||
          ...
          new d().implementThePolyfill()),
        f.checkAndAssignCspTrustedTypeEnabled(t) &&
          f.initCSPTrustedType(c.storageBaseURL),
        !t.RuleSet[0].Type)
      )
        return (
          (this.iabTypeAdded = !1),
    ...
    (b.prototype.getGeolocationURL = function (t) {
      ...
      var e =
        "" +
        c.stubScriptElement.getAttribute("src").split(c.stubFileName)[0] +
        t.Version;
    ...
    (b.prototype.setOTDataLayer = function () {
      ...
      this.otDataLayer = {
        ignore: (e && "true" === t) || (e && "" === t),
        name:
          c.stubScriptElement.getAttribute("data-dLayer-name") || "dataLayer",
      };
    }),
    ...
    (b.prototype.otFetch = function (t, i, e, n, a) {
      ...
      var o =
        window.sessionStorage && window.sessionStorage.getItem("otPreviewData");
    ...
    (b.prototype.jsonp = function (t, e, i, n) {
      ...
      (a.setAttribute("src", o),
        ...
        i && n && (a.integrity = n),
        this.crossOrigin && a.setAttribute("crossorigin", this.crossOrigin),
        document.getElementsByTagName("head")[0].appendChild(a),
        new RegExp("^file://", "i").test(t) || c.mobileOnlineURL.push(t),
        e &&
          (a.onload = a.onerror =
            function () {
              e();
    ...
    (b.prototype.validateIABGlobalScope = function () {
      var t = this.readCookieParam(
        c.optanonCookieName,
        c.oneTrustIsIABCrossConsentEnableParam,
      );
      t
        ? "true" === t
          ? ((c.hasIABGlobalScope = !0), (c.isStubReady = !1))
          : ((c.hasIABGlobalScope = !1),
            (c.IABCookieValue = this.getCookie(c.oneTrustIABCookieName)))
        : (c.isStubReady = !1);
    }),
    (b.prototype.validateIABGDPRApplied = function () {
      ...
      t
        ? this.isBoolean(t)
          ? (c.oneTrustIABgdprAppliesGlobally = "true" === t)
          : (c.oneTrustIABgdprAppliesGlobally = 0 <= c.EUCOUNTRIES.indexOf(t))
        : (c.isStubReady = !1);
    }),
    ...
    (b.prototype.getCookieNameSuffix = function () {
      return this.scriptType === p &&
        this.subDomainEnabled &&
        this.domainHashValue
        ? "_" + this.domainHashValue
        : "";
    }),
    (b.prototype.getCookie = function (t) {
      ...
      for (
        var i = "" + t + this.getCookieNameSuffix() + "=",
          n = 0,
    ...
    (b.prototype.updateGtmMacros = function () {
      for (var t = [], e = c.optanonHtmlGroupData.length, i = 0; i < e; i++)
        this.endsWith(c.optanonHtmlGroupData[i], ":1") &&
          t.push(c.optanonHtmlGroupData[i].replace(":1", ""));
      for (e = c.optanonHostData.length, i = 0; i < e; i++)
        this.endsWith(c.optanonHostData[i], ":1") &&
          t.push(c.optanonHostData[i].replace(":1", ""));
      for (e = c.genVendorsData.length, i = 0; i < e; i++)
        this.endsWith(c.genVendorsData[i], ":1") &&
          t.push(c.genVendorsData[i].replace(":1", ""));
      for (e = c.vendorsServiceData.length, i = 0; i < e; i++)
        this.endsWith(c.vendorsServiceData[i], ":1") &&
          t.push(c.vendorsServiceData[i].replace(":1", ""));
      var n,
    ...
    (b.prototype.setStubScriptElement = function () {
      c.stubScriptElement = document.querySelector(
        "script[src*='" + c.stubFileName + "']",
      );
      var t = c.stubScriptElement && c.stubScriptElement.getAttribute("src"),
        t = t && this.getStubQueryParam(t, "did");
      c.stubScriptElement &&
      c.stubScriptElement.hasAttribute(c.DATAFILEATTRIBUTE)
        ? (this.domainId = c.stubScriptElement
            .getAttribute(c.DATAFILEATTRIBUTE)
            .trim())
        : t
          ? (this.domainId = t)
          : c.stubScriptElement ||
            ((c.stubScriptElement = document.querySelector(
              "script[src*='" + c.migratedCCTID + "']",
            )),
            c.stubScriptElement &&
              ((c.isMigratedURL = !0),
              (this.domainId = c.migratedDomainId.trim())));
    }),
    (b.prototype.setDomainDataFileURL = function () {
      ...
      (t &&
        (c.isMigratedURL
          ? (c.storageBaseURL = t.split("/consent/" + c.migratedCCTID)[0])
          : (c.storageBaseURL = (
              e
                ? t.split("/consent")
                : t.split("/scripttemplates/" + c.stubFileName)
            )[0])),
        (this.storageBaseURL = c.storageBaseURL),
        this.isPreview && -1 === this.domainId.indexOf("test")
          ? (this.domainId = this.domainId + "-test")
          : (this.isPreview = !1),
        (c.bannerBaseDataURL =
          c.storageBaseURL && c.storageBaseURL + "/consent/" + this.domainId),
        (c.bannerDataParentURL =
          c.bannerBaseDataURL + "/" + this.domainId + ".json"));
    }),
  ...
  function b() {
    ...
    ((this.iabType = null),
      ...
      (this.charset = null),
      (this.isShopify = !1),
      (this.subDomainEnabled = !1),
      (this.domainHashValue = ""),
      (this.scriptType = ""),
      (this.buildType = "undefined"),
      (this.addBannerSDKScript = function (s) {
        return e(r, void 0, void 0, function () {
          var e, i, n, a, o;
          return u(this, function (t) {
            switch (t.label) {
              case 0:
                return ((e = this.getRegionSet(s)).GCEnable ||
                  (this.updateGtmMacros(), (this.gtmUpdated = !0)),
                this.iabTypeAdded &&
                  (("IAB2" !== e.Type && "IAB2V2" !== e.Type) ||
                    ((this.iabType = e.Type), this.intializeIabStub()),
                  "IAB2" !== e.Type) &&
                  "IAB2V2" !== e.Type &&
                  this.removeTcf(),
                e.IsGPPEnabled ? g.init() : g.removeGppApi(),
                (i = c.stubScriptElement.cloneNode(!0)),
                (n = ""),
                (n = s.UseSDKRefactor
                  ? (c.isMigratedURL &&
                      (i.src =
                ...
                [
                  ...
                  c.stubScriptElement.getAttribute(t) &&
                    i.setAttribute(t, c.stubScriptElement.getAttribute(t));
                }),
                (this.charset = c.stubScriptElement.getAttribute("charset")),
                (this.isAmp = !!c.stubScriptElement.getAttribute("amp")),
                c.stubScriptElement.getAttribute("integrity"))
                  ? ((o =
                      s.CDNLocation +
                      "/scripttemplates/" +
                      s.Version +
                      "/sri-hashes.json"),
                    [4, this.fetchSriHash(o)])
                  : [3, 2];
              case 1:
                return ((a = t.sent()), [3, 3]);
              case 2:
              ...
              case 3:
                return (
                  (window.otStubData = {
                    ...
                    regionRule: e,
                    setAttributePolyfillIsActive:
                      this.setAttributePolyfillIsActive,
                  ...
                  this.jsonp(
                    ...
                    null,
                    !0,
                    null == (o = a) ? void 0 : o["otBannerSdk.js"],
                  ),
                  [2]
                );
            }
          ...
          return u(this, function (t) {
            switch (t.label) {
              ...
              case 4:
                return (
                  (e = t.sent()),
                  console.error("Error fetching SRI hash:", e),
                  [3, 5]
                );
              case 5:
                return [2, null];
      ...
      (this.intializeIabStub = function () {
        var t = window;
        (r.iabTypeAdded
          ? (void 0 === t.__tcfapi && (window.__tcfapi = r.executeTcfApi),
            r.addIabFrame())
          : r.addBackwardIabFrame(),
          (t.receiveOTMessage = r.receiveIabMessage),
      ...
      (this.executeTcfApi = function () {
        ...
        "function" == typeof a &&
          i &&
          ("ping" === i ? r.getPingRequest(a) : r.addToQueue(i, n, a, o));
      }),
      ...
      (this.getPingRequest = function (t, e) {
        ...
        t &&
          ((n = !(i = {})),
          ("IAB2" !== r.iabType && "IAB2V2" !== r.iabType) ||
            ((i = {
