...
function AppMeasurement(e) {
  ...
  ((t.log = function (e) {
      ...
      function (e) {
        ...
        return "[[B]]" !=
          (e =
            0 > a
              ? ""
              : t.unescape(n.substring(a + 2 + e.length, 0 > i ? n.length : i)))
          ? e
          : "";
      }),
    (t.c_w = t.cookieWrite =
    ...
    (t.Yb = function () {
      ...
      "number" == typeof e &&
        10 > e &&
        ((t.unsupportedBrowser = !0), t.Jb(t, function () {}));
    }),
    (t.Ea = function () {
    ...
    (t.ja = function (e, n, a) {
      ...
      if ((o || (o = t.d.webkitVisibilityState), o && "prerender" == o)) {
        if (!t.ka)
          for (t.ka = 1, a = 0; a < c.length; a++)
            t.d.addEventListener(c[a], function () {
              var e = t.d.visibilityState;
              (e || (e = t.d.webkitVisibilityState),
                "visible" == e && ((t.ka = 0), t.delayReady()));
            });
        ((i = 1), (r = 0));
      } else a || (t.v("_d") && (i = 1));
      return (
        i &&
          (t.M.push({ m: e, a: n, t: r }),
          t.ka || setTimeout(t.delayReady, t.maxDelay)),
        i
      );
    }),
          ...
          t.lightProfileID
            ...
            : ((a = t.i),
              (t.pe || t.linkType) &&
                ...
                (i = t.linkTrackEvents),
                t.pe &&
                  ((r = t.pe.substring(0, 1).toUpperCase() + t.pe.substring(1)),
                  t[r] && ((c = t[r].qc), (i = t[r].pc)))),
              c && (c = "," + c + "," + t.F.join(",") + ","),
              i && c && (c += ",events,")),
          n && (n = "," + n + ","),
          i = 0;
    ...
    (t.l = function (e, n, a, i, r) {
      var o,
        ...
        f = 0;
      if (
        ("contextData" == e && (e = "c"), "clientHints" == e && (e = "h"), n)
      ) {
        for (o in n)
          if (
            !(Object.prototype[o] || (r && o.substring(0, r.length) != r)) &&
            n[o] &&
            (!a || 0 <= a.indexOf("," + (i ? i + "." : "") + o + ","))
          ) {
            if (((s = !1), f))
            ...
            if (
              ...
              if (0 < (s = o.indexOf(".")))
                ...
                ("boolean" == typeof c && (c = c ? "true" : "false"), c)
              ) {
                if ("retrieveLightData" == i && 0 > r.indexOf(".contextData."))
                  switch (((s = o.substring(0, 4)), (l = o.substring(4)), o)) {
                    case "transactionID":
                      o = "xact";
                      break;
                    case "channel":
    ...
    (t.ec = function () {
      ...
      for (
        t.AudienceManagement &&
          ...
          (u += t.l("d", t.AudienceManagement.getEventCallConfigParams())),
          n = 0;
        n < e.length;
        n++
      ) {
        if (
          ...
          switch (r) {
            ...
            case "events":
              if ((g && (o += ("" != o ? "," : "") + g), p))
                for (c = o.split(","), o = "", i = 0; i < c.length; i++)
                  (0 <= (l = (s = c[i]).indexOf("=")) &&
                    (s = s.substring(0, l)),
          ...
          o &&
            (u +=
              "&" + r + "=" + ("pev" != r.substring(0, 3) ? t.escape(o) : o));
        }
        "pev3" == r && t.e && (u += t.e);
      }
    ...
    (t.C = function (e) {
      var t = e.tagName;
      return "undefined" != "" + e.xc ||
        ("undefined" != "" + e.lc && "HTML" != ("" + e.lc).toUpperCase())
        ? ""
        : ("SHAPE" == (t = t && t.toUpperCase ? t.toUpperCase() : "") &&
            (t = ""),
          t &&
            (("INPUT" == t || "BUTTON" == t) && e.type && e.type.toUpperCase
    ...
    (t.vc = function (e) {
      for (var n = t.C(e), a = t.N(e); e && !a && "BODY" != n; )
        (e = e.parentElement ? e.parentElement : e.parentNode) &&
          ((n = t.C(e)), (a = t.N(e)));
      return (
        (a && "BODY" != n) || (e = 0),
        e &&
          (0 <= (n = e.onclick ? "" + e.onclick : "").indexOf(".tl(") ||
    ...
    (t.kc = function () {
      ...
      if (((t.qa = 1), o || ((t.qa = 0), (o = t.clickObject)), o)) {
        for (e = t.C(o), a = t.N(o); o && !a && "BODY" != e; )
        ...
        if (
          ...
          t.Xa(l) &&
            (t.linkInternalFilters ||
              (t.linkInternalFilters = n.location.hostname),
            (i = 0),
            t.linkExternalFilters
              ? ((i = t.linkExternalFilters.toLowerCase().split(",")), (f = 1))
              : t.linkInternalFilters &&
                (i = t.linkInternalFilters.toLowerCase().split(",")),
            i))
        ) {
      ...
      ((t.linkObject = o),
        ...
        (t.trackClickMap || t.trackInlineStats) &&
          ...
          o &&
            ...
            (o = o.sourceIndex),
            c || ((c = t.pageURL), (s = 0)),
            n.s_objectID && ((a.id = n.s_objectID), (o = a.type = 1)),
            c &&
              a &&
              a.id &&
              e &&
    ...
    (t.fc = function () {
      ...
      if (
        (n &&
          ...
          (t.pe = "lnk_" + n),
          t.decodeLinkParameters
            ? ((t.pev1 = a ? t.unescape(a) : ""),
              (t.pev2 = i ? t.unescape(i) : ""),
              (t.pev1 = t.escape(t.pev1)),
              (t.pev2 = t.escape(t.pev2)))
            : ((t.pev1 = a ? t.escape(a) : ""),
              (t.pev2 = i ? t.escape(i) : "")),
          (e = 1)),
        t.abort && (e = 0),
        t.trackClickMap || t.trackInlineStats || t.hc())
      ) {
        ((n = {}), (a = 0));
        var r,
          o,
        ...
        for (c in ((i = t.account.split(",")), (r = {}), t.contextData))
          c &&
            !Object.prototype[c] &&
        ...
        if (((t.e = t.l("c", r) + (t.e ? t.e : "")), e || t.e)) {
          ...
          if ((e || (a = 1), a)) {
            ...
            !e &&
              t.e &&
              ((l = t.escape(i.join(",")) + "=" + t.escape(t.e)), (r = 1)),
            n))
              !Object.prototype[o] &&
                0 < r &&
                0 < n[o].length &&
    ...
    (t.gc = function () {
      if (!t.oc) {
        ...
        if (
          a.setUTCDate &&
          ((l = "1.3"), (0).toPrecision && ((l = "1.5"), (a = []).forEach))
        ) {
          ((l = "1.6"), (n = 0), (e = {}));
          try {
        ...
        ((e = screen.width + "x" + screen.height),
          ...
          (o = t.w.innerWidth
            ? t.w.innerWidth
            : t.d.documentElement.offsetWidth),
          (s = t.w.innerHeight
            ? t.w.innerHeight
      ...
      if (t.collectHighEntropyUserAgentHints && !t.J && t.jb()) {
        ...
        try {
          navigator.userAgentData
            .getHighEntropyValues(t.wa)
            .then(function (e) {
              ((t.clientHints = {}),
                t.wa.forEach(function (n) {
                  Object.prototype.hasOwnProperty.call(e, n) &&
                    (t.clientHints[n] = e[n]);
                }));
            })
      ...
      if (!i) {
        ((i = n["AppMeasurement_Module_" + e]
          ...
          (i.Mb = function (n) {
            (i.Gb = n) &&
              ((t[e + "_onLoad"] = n),
              t.ja(e + "_onLoad", [t, i], 1) || n(t, i));
          }));
        try {
          Object.defineProperty
            ? Object.defineProperty(i, "onLoad", { get: i.vb, set: i.Mb })
            : (i._olc = 1);
        } catch (e) {
          i._olc = 1;
        }
    ...
    (t.v = function (e) {
      ...
      for (n in t.S)
        if (
          !Object.prototype[n] &&
          (a = t.S[n]) &&
          (a._olc && a.onLoad && ((a._olc = 0), a.onLoad(t, a)), a[e] && a[e]())
        )
          return 1;
      return 0;
    }),
    ...
    (t.tc = function (e) {
      var n, a, i, r;
      for (n = 0; 2 > n; n++)
        for (a = 0 < n ? t.Na : t.i, i = 0; i < a.length; i++)
          ((e[(r = a[i])] = t[r]),
            e[r] ||
    ...
    (t.$b = function (e) {
      ...
      if (
        ...
        ((o = t.substring(n + 1)),
        (a = 0),
        "http://" == (i = (t = t.substring(0, n)).toLowerCase()).substring(0, 7)
          ? (a += 7)
    ...
    (t.isReadyToTrack = function () {
      ...
      return (
        !(!t.Ab() || !t.yb()) &&
        (t.Cb() || (e = !1), t.Fb() || (e = !1), t.nb() || (e = !1), e)
      );
    }),
    (t.Ab = function () {
      return (
        t.ga || t.H || (t.mb(t.Pb) ? (t.H = !0) : (t.ga = !0)),
        !(t.ga && !t.H)
      );
    }),
    (t.yb = function () {
      ...
      if (e) {
        if (!t.ya && !t.fa)
          return (e.fetchPermissions(t.Hb, !0), (t.fa = !0), !1);
        if (!t.ya) return !1;
    ...
    (t.Cb = function () {
      ...
      return (
        !e ||
        !e.getVisitorValues ||
        (t.ca && ((t.ca = !1), t.K || ((t.K = !0), e.getVisitorValues(t.Qb))),
        !t.K)
      );
    }),
    (t.W = function () {
    ...
    (t.Fb = function () {
      return (
        t.ea || t.G || (t.lb(t.Ga) ? (t.G = !0) : (t.ea = !0)),
        !(t.ea && !t.G)
      );
    }),
    (t.nb = function () {
        ...
        t.ic() &&
          ...
          t.account &&
            (t.abort ||
              (t.trackOffline &&
                !t.timestamp &&
                (t.timestamp = Math.floor(i.getTime() / 1e3)),
              (e = n.location),
              t.pageURL || (t.pageURL = e.href ? e.href : e),
              t.referrer ||
                t.hb ||
                ((e = t.Util.getQueryParam("adobe_mc_ref", null, null, !0)),
                (t.referrer =
                  e || void 0 === e
                    ? void 0 === e
                      ? ""
                    ...
                    : c.document.referrer)),
              (t.hb = 1),
              !t.referrer && t.da && (t.referrer = t.da),
              (t.da = 0),
              (t.referrer = t.$b(t.referrer)),
              t.v("_g")),
            t.fc() &&
              !t.abort &&
              (s &&
              ...
              t.X("AAM") || (t.contextData["cm.ssf"] = 1),
              t.gc(),
              t.Ib(),
              (o += t.ec()),
              t.Eb(r, o),
    ...
    (t.tl = t.trackLink =
      function (e, n, a, i, r) {
        return (
          ...
          (t.linkType = n),
          (t.linkName = a),
          r && ((t.bodyClickTarget = e), (t.bodyClickFunction = r)),
          t.track(i)
        );
      }),
    ...
    (t.clearVars = function () {
      var e, n;
      for (e = 0; e < t.i.length; e++)
        ("prop" == (n = t.i[e]).substring(0, 4) ||
    ...
    (t.Eb = function (e, a) {
      var i =
        ...
        e +
        "?AQB=1&ndh=1&pf=1&" +
        (t.Fa() ? "callback=s_c_il[" + t._in + "].doPostbacks&et=1&" : "") +
        a +
        "&AQE=1";
    ...
    (t.tb = function () {
      ...
      return (
        ...
        t.version +
        (t.nc ? "T" : "") +
        (t.tagContainerMarker ? "-" + t.tagContainerMarker : "")
      );
    }),
    (t.Fa = function () {
      return (
        (t.AudienceManagement && t.AudienceManagement.isReady()) ||
        0 != t.usePostbacks
      );
    }),
    (t.ub = function () {
      ...
      return (
        n
          ? t.trackingServerSecure && t.ssl && (n = t.trackingServerSecure)
    ...
    (t.wb = function () {
      ...
      return (
        e || (e = (e = t.account.split(",")[0]).replace(/[^0-9a-z]/gi, "")),
        e
      );
    }),
    (t.gb = /{(%?)(.*?)(%?)}/),
    (t.sc = RegExp(t.gb.source, "g")),
    (t.Zb = function (e) {
    ...
    (t.ta = function () {
      var e = !0;
      return (
        (t.trackOffline && t.storageFilename && t.o(n.localStorage)) ||
          (e = !1),
        e
      );
    }),
    ...
    (t.Sb = function () {
      var e;
      return !t.trackOffline || 0 >= t.offlineThrottleDelay
        ? 0
        : ((e = t.B() - t.ab),
  ...
  for (
      ...
      t.mc = function (e) {
        ...
        if (
          ...
          !i &&
            t.Da() &&
            2047 < e.length &&
            (t.kb() && ((r = 2), (i = new XMLHttpRequest())),
            i &&
              ((t.AudienceManagement && t.AudienceManagement.isReady()) ||
                0 != t.usePostbacks) &&
              (t.Z ? (i.Oa = !0) : (i = 0))),
          !i && t.rc && (e = e.substring(0, 2047)),
          !i &&
            t.d.createElement &&
            (0 != t.usePostbacks ||
              (t.AudienceManagement && t.AudienceManagement.isReady())) &&
            ...
            ("async" in i) &&
            ((o =
              (o = t.d.getElementsByTagName("HEAD")) && o[0] ? o[0] : t.d.body)
          ...
          (i.onabort =
            ...
            i.la =
              function () {
                (i.Qa(),
                  (t.trackOffline || t.ra) && t.p && t.g.unshift(t.Wb),
                  (t.p = 0),
                  t.na > t.P && t.cb(t.g),
                  t.ha(),
                  t.va(500));
        ...
        ((i.D = setTimeout(function () {
          i.D &&
            (i.complete
              ? i.T()
              : (t.trackOffline && i.abort && i.abort(), i.la()));
        }, 5e3)),
          (t.Wb = e),
          (t.A = n["s_i_" + t.replace(t.account, ",", "_")] = i),
          ((t.useForcedLinkTracking && t.L) || t.bodyClickFunction) &&
            (t.forcedLinkTrackingTimeout || (t.forcedLinkTrackingTimeout = 250),
            (t.ia = setTimeout(t.ha, t.forcedLinkTrackingTimeout))));
      },
      t.zb = function (e) {
        var n = !1;
        return (
          navigator.sendBeacon && (t.Bb(e) || t.useBeacon) && (n = !0),
          t.Kb(e) && (n = !1),
          n
        );
      },
            ...
            e && a
              ? 0 > (o = (a = "" + a).indexOf("?"))
                ...
                : ((a = i + a.substring(o + 1) + i),
                  r &&
                  (0 <= a.indexOf(i + e + i) || 0 <= a.indexOf(i + e + "=" + i))
                    ? void 0
                    : (0 <= (o = a.indexOf("#")) && (a = a.substr(0, o) + i),
                      0 > (o = a.indexOf(i + e + "=")) ||
                        (0 <=
                          (o = (a = a.substring(
                            o + i.length + e.length + 1,
                          )).indexOf(i)) && (a = a.substring(0, o)),
    ...
    (76 > i && (t.i.push("prop" + i), t.Q.push("prop" + i)),
      t.i.push("eVar" + i),
      t.Q.push("eVar" + i),
      6 > i && t.i.push("hier" + i),
      4 > i && t.i.push("list" + i));
  ((i =
    ...
    (t.charSet = "UTF-8"),
    (t.contextData = {}),
    (t.wa = ["architecture", "bitness", "model", "platformVersion", "wow64"]),
    (t.writeSecureCookies = !1),
    (t.collectHighEntropyUserAgentHints = !1),
    (t.offlineThrottleDelay = 0),
    (t.storageFilename = "AppMeasurement.requests"),
    (t.R = "s_sq"),
    (t.ab = 0),
    (t.na = 0),
    (t.P = 0),
    ...
    (t.d = n.document),
    (t.ha = function () {
      (t.ia && (n.clearTimeout(t.ia), (t.ia = a)),
        t.bodyClickTarget && t.L && t.bodyClickTarget.dispatchEvent(t.L),
        t.bodyClickFunction &&
          ("function" == typeof t.bodyClickFunction
            ? t.bodyClickFunction()
            : t.bodyClickTarget &&
              t.bodyClickTarget.href &&
              (t.d.location = t.bodyClickTarget.href)),
        (t.bodyClickTarget = t.L = t.bodyClickFunction = 0));
    }),
    (t.eb = function () {
      ((t.b = t.d.body),
        t.b
          ? ((t.u = function (e) {
              ...
              if (
                ...
                if (t.Pa) {
                  if (!t.useForcedLinkTracking)
                    return (
                      t.b.removeEventListener("click", t.u, !0),
                      void (t.Pa = t.useForcedLinkTracking = 0)
                    );
                ...
                try {
                  if (
                    ...
                    !(
                      t.clickObject.tagName ||
                      t.clickObject.parentElement ||
                      t.clickObject.parentNode
                    )
                  )
                    t.clickObject = 0;
                  else {
                    ...
                    if (
                      (t.ma && (clearTimeout(t.ma), (t.ma = 0)),
                      (t.ma = setTimeout(function () {
                        t.O == s && (t.O = 0);
                      }, 1e4)),
                      (r = t.Va()),
                      t.track(),
                      r < t.Va() && t.useForcedLinkTracking && e.target)
                    ) {
                      for (
                        o = e.target;
                        o &&
            ...
            t.b && t.b.attachEvent
              ...
              : t.b &&
                ...
                t.b.addEventListener("click", t.u, !1)))
          : setTimeout(t.eb, 30));
    }),
    (t.rc = t.Ea()),
    t.Yb(),
...
function s_pgicq() {
  ...
  if (i)
    for (e = 0; e < i.length; e++)
      ((n = s_gi((t = i[e]).oun)).setAccount(t.un),
