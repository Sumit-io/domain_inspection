...
function AppMeasurement_Module_ActivityMap(e) {
  ...
  function n() {
    if (l.scrollReachSelector) {
      var t = e.d.querySelector && e.d.querySelector(l.scrollReachSelector);
      t
        ? ((f = t.scrollTop || 0),
        ...
        : 0 < g-- && setTimeout(n, 1e3);
    }
  }
  function r(e, t) {
    var n, r, i;
    if (e && t && (n = l.c[t] || (l.c[t] = t.split(","))))
  ...
  function i(t, n, r, i, a) {
    var c, o;
    if (
      (((t.dataset && (o = t.dataset[n])) ||
        (t.getAttribute &&
          ((o = t.getAttribute("data-" + r)) || (o = t.getAttribute(r))))) &&
        (c = o),
      !c && e.useForcedLinkTracking && a)
    ) {
      var l;
      if (
        ...
        for (r += i.length; r < t.length; )
          if (((o = t.charAt(r++)), 0 <= "'\"".indexOf(o))) {
            l = o;
            break;
          }
        for (
          var s = !1;
          r < t.length && l && ((o = t.charAt(r)), s || o !== l);
        )
          ("\\" === o ? (s = !0) : ((n += o), (s = !1)), r++);
      }
      (l = n) && (e.w[i] = l);
  ...
  function a(e, t, n) {
    var i;
    return (i = l[t](e, n)) && r(o(i), l[t + "Exclusions"]);
  }
  function c(e, t, n) {
    var r;
    if (
      ...
      (1 === e.nodeType && (r = e.nodeValue) && (t[t.length] = r),
      n.a ||
        n.t ||
        n.s ||
        !e.getAttribute ||
        ((r = e.getAttribute("alt"))
          ...
          : (r = e.getAttribute("title"))
            ...
            : "IMG" == ("" + e.nodeName).toUpperCase() &&
              (r = e.getAttribute("src") || e.src) &&
              (n.s = r)),
      (r = e.childNodes) && r.length)
    )
      for (e = 0; e < r.length; e++) c(r[e], t, n);
  }
  function o(e) {
  ...
  var u,
    ...
    g = 60;
  l.c = {};
  var p = { SCRIPT: 1, STYLE: 1, LINK: 1, CANVAS: 1 };
  ((l._g = function () {
    var t,
      n,
      r,
    ...
    (l._d = function () {
      l.trackScrollReach &&
        !u &&
        (l.scrollReachSelector
          ? n()
          : (t(), s.addEventListener && s.addEventListener("scroll", t, !1)),
        (u = !0));
    }),
    (l.link = function (e, t) {
      var n;
      if (t) n = r(o(t), l.linkExclusions);
      else if (
        (n = e) &&
        !(n = i(e, "sObjectId", "s-object-id", "s_objectID", 1))
      ) {
        var a, s;
        ((s = r(o(e.innerText || e.textContent), l.linkExclusions)) ||
          (c(e, (a = []), (n = { a: void 0, t: void 0, s: void 0 })),
          (s = r(o(a.join("")))) ||
            (s = r(o(n.a ? n.a : n.t ? n.t : n.s ? n.s : void 0))) ||
            !(a = (a = e.tagName) && a.toUpperCase ? a.toUpperCase() : "") ||
            ("INPUT" == a || ("SUBMIT" == a && e.value)
              ? (s = r(o(e.value)))
              : "IMAGE" == a && e.src && (s = r(o(e.src))))),
          (n = s));
      }
      return n;
    }),
    (l.region = function (e) {
      for (var t, n = l.regionIDAttribute || "id"; e && (e = e.parentNode); ) {
